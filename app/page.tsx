    ...
    <main className="min-h-screen bg-background flex flex-col">
      ...
      <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-md border-b border-border" role="banner">
        <div className="container mx-auto px-4 py-4 flex flex-col gap-4">
          ...
          {/* Navigation Tabs */}
          <nav className="flex items-center gap-2 justify-center sm:justify-start" aria-label="Main navigation">
            <Link
              href="/mira"
              className="px-4 py-2 rounded-full bg-cyan-100 text-cyan-900 hover:bg-cyan-200 transition-colors text-sm font-medium"
            >
              Meet Mira
            </Link>
            <Link
              href="/echoes"
              className="px-4 py-2 rounded-full bg-rose-100 text-rose-900 hover:bg-rose-200 transition-colors text-sm font-medium"
            >
              Echoes
            </Link>
            <Link
              href="/unsent"
              className="px-4 py-2 rounded-full bg-yellow-100 text-yellow-900 hover:bg-yellow-200 transition-colors text-sm font-medium"
            >
              Unsent
            </Link>
          </nav>
      ...
      {/* Footer */}
      <footer className="sticky bottom-0 bg-background/95 backdrop-blur-md border-t border-border z-40" role="contentinfo">
