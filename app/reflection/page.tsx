...
import { DEFAULT_ROOM_ID, getRoomConfig } from "@/lib/room-config"
...
function ReflectionContent() {
  ...
  const emotion = searchParams.get("emotion") || DEFAULT_ROOM_ID
  ...
  const bgGradient = roomConfig.reflectionGradientClass
