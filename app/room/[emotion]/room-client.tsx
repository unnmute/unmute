...
export function RoomClient({ emotion }: { emotion: string }) {
  ...
  const safeEmotion = roomConfig.id
  ...
  const color = roomConfig.sessionColor
      ...
      <>
        ...
        <main className="min-h-screen bg-background relative overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            {/* Main gradient */}
            <div className={`absolute inset-0 bg-gradient-to-br ${roomConfig.roomPageBackgroundGradientClass}`} />
          ...
          <header className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-b border-border">
            <div className="container mx-auto px-4 py-4 flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <h1 className={`text-lg font-medium ${roomConfig.roomPageTextColorClass} animate-in fade-in slide-in-from-left-2 duration-300`} aria-live="polite">
                  {roomConfig.sanctuaryLabel}
                </h1>
              </div>
          ...
          {!isCompleted && (
              <SilentReactionsSimple
                  ...
                  myUserId={anonymousUserId ?? undefined}
              />
          )}
