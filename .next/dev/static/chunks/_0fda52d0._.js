...
"[project]/lib/fingerprint.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fingerprint$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/fingerprint.ts [app-client] (ecmascript)");
...
function useSession(emotion) {
    ...
    const [freeLimitReached, setFreeLimitReached] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [freeSessionsUsed, setFreeSessionsUsed] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    // Initialize anonymous ID
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useSession.useEffect": ()=>{
            setAnonymousId((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fingerprint$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFingerprint"])());
        }
    }["useSession.useEffect"], []);
    const syncDeviceJoin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSession.useCallback[syncDeviceJoin]": async (user)=>{
            const fp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fingerprint$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFingerprint"])();
            if (!fp) return {
                isBanned: false,
                joinCount: 0
            };
    ...
    }["useSession.useCallback[syncDeviceJoin]"], []);
    const incrementDeviceJoinCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSession.useCallback[incrementDeviceJoinCount]": async (user)=>{
            const fp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fingerprint$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFingerprint"])();
            if (!fp) return null;
            const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
    ...
    }["useSession.useCallback[incrementDeviceJoinCount]"], []);
    const getFreeSessionState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSession.useCallback[getFreeSessionState]": ()=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
    ...
    const countFreeSessionForRoom = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSession.useCallback[countFreeSessionForRoom]": (roomId)=>{
    ...
    }["useSession.useCallback[countFreeSessionForRoom]"], [
        getFreeSessionState
    ]);
    const signInWithGoogle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSession.useCallback[signInWithGoogle]": async ()=>{
            const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
            const redirectTo = ("TURBOPACK compile-time truthy", 1) ? window.location.href : "TURBOPACK unreachable";
    ...
    }["useSession.useCallback[signInWithGoogle]"], []);
...
_s(useSession, "IKWqF7cu7EzknSapG1Hf2v3CPgM=", false, function() {
    return [
...
function RoomClient({ emotion }) {
    ...
    const [showReportSheet, setShowReportSheet] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [reportStep, setReportStep] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1);
    const [reportTargets, setReportTargets] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [selectedReportReason, setSelectedReportReason] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [reportError, setReportError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [reportToast, setReportToast] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const { room, session, leaveRoom, sendReaction, freeLimitReached, freeSessionLimit, signInWithGoogle } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSession"])(safeEmotion);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RoomClient.useEffect": ()=>{
            ...
            const checkBanStatus = {
                "RoomClient.useEffect.checkBanStatus": async ()=>{
                    const fingerprint = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fingerprint$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFingerprint"])();
            ...
            }["RoomClient.useEffect.checkBanStatus"];
            checkBanStatus();
            const interval = setInterval(checkBanStatus, 5000);
            return ({
                "RoomClient.useEffect": ()=>clearInterval(interval)
            })["RoomClient.useEffect"];
        }
    }["RoomClient.useEffect"], [
        mounted,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RoomClient.useEffect": ()=>{
            ...
            const loadReportTargets = {
                "RoomClient.useEffect.loadReportTargets": async ()=>{
                    setReportError(null);
                    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
                    const { data, error } = await supabase.from("sessions").select("id, room_alias").eq("room_id", room.id).neq("id", session.id).neq("anonymous_id", (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fingerprint$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFingerprint"])()).is("left_at", null);
                    if (error) {
            ...
            }["RoomClient.useEffect.loadReportTargets"];
            loadReportTargets();
        }
    }["RoomClient.useEffect"], [
        showReportSheet,
    ...
    const submitReport = async ()=>{
        ...
        const { error } = await supabase.from("reports").insert({
            reporter_fingerprint: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fingerprint$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFingerprint"])(),
          ...
          `,
            ...
            `,
                          ...
                          `,
                                                ...
                                                session?.room_alias && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            ...
            reportToast && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            showReportSheet && !isCompleted && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            reportStep === 1 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "jsx-a1972fb3a6eb61d2",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: reportTargets.length > 0 ? reportTargets.map((target)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                type: "button",
                                                onClick: ()=>{
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "jsx-a1972fb3a6eb61d2" + " " + "mt-4 flex flex-wrap gap-2",
                                        children: REPORT_REASONS.map((reason)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                type: "button",
...
_s(RoomClient, "ePj7jhxZdCrZZFGFc/FO8yTpjUQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=_0fda52d0._.js.map