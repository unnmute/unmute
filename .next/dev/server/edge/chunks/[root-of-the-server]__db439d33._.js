(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__db439d33._.js",
...
"[project]/app/api/reactions/route.ts [app-edge-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    if (error && (error.code === "23514" || error.message.toLowerCase().includes("reaction_type"))) {
        const fallback = await supabase.from("reactions").insert({
            room_id: roomId,
            session_id: sessionId,
            reaction_type: legacyReactionMap[reactionType]
        }).select().single();
        if (!fallback.error) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                reaction: {
...
async function GET(request) {
    ...
    const { data: reactions, error } = await supabase.from("reactions").select("*").eq("room_id", roomId).gte("created_at", oneMinuteAgo).order("created_at", {
        ascending: false
    });
    if (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__db439d33._.js.map