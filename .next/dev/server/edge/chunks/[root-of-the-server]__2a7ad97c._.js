(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__2a7ad97c._.js",
...
"[project]/app/api/twin/match/route.ts [app-edge-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const { data: matches, error } = await supabase.from("twin_matches").select("*").eq("question_date", questionDate).gt("expires_at", new Date().toISOString()).or(`user_a_anonymous_id.eq.${anonymousId},user_b_anonymous_id.eq.${anonymousId}`).order("created_at", {
        ascending: false
    }).limit(1);
    if (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2a7ad97c._.js.map